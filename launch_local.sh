...
max_fishes_count=64
comm_freq=1
#output="HPC-Project/time_results/F${test_function}/local_CF${comm_freq}_breeding.csv"
output="HPC-Project/time_results/F${test_function}/local_CF${comm_freq}.csv"
